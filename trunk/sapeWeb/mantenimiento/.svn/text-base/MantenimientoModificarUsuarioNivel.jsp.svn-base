		<!-- MantenimientoModificarUsuarioNivel.jsp -->
...
<table align="center" width="40%" BGCOLOR="BLACK">
	<tr>
		<td><font color="white" size="4" face="Arial"><CENTER><B>Modificar Usuario</font></td>
	</tr>
</table>
...
<tr>
	<td width="40%"><FONT face="Verdana" COLOR="BLACK" SIZE=3>Nombre de Usuario</FONT></td>
	<td>
		<FONT face="Verdana" COLOR="BLACK" SIZE=2>
		<INPUT TYPE="text" NAME="nick" size="10" VALUE="${user.nick}" MAXLENGTH="10" disabled>
		</FONT>
	</td>
</TR>
...
<td>
<FONT face="Verdana" COLOR="BLACK" SIZE=2>
<input name="contrasena" size="10" value="" maxlength="10" type="password">
</FONT>
</td>
</TR>
...
<td>
<FONT face="Verdana" COLOR="BLACK" SIZE=2>
<INPUT TYPE="text" NAME="nombre" size="35" VALUE="${user.nombre}" MAXLENGTH="50">
</FONT>
</td>
</TR>
...
<INPUT name='modificar' ONCLICK='javascript:verif_entradas(document.modificarUsuario)' type='button' value=' Modificar Usuario '></FONT></TD>
