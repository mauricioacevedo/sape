...
<tr bgcolor="black">
	<td align="center" width="15%" class="header-reporte">Central</td>
	...
	<td align="center" width="15%" class="header-reporte">Cabeza 2</td>
	<td align="center" width="15%" class="header-reporte">LL</td>
	<td align="center" width="15%" class="header-reporte">Vertical</td>
...
<tr class="row${row}">
	<td align="center">${fast.central}</td>
	<td align="center">${fast.numeroFast}</td>
	<td align="center">${fast.telefonoFast}</td>
	<td align="center">${fast.id}</td>
	<td align="center">${fast.id2}</td>
	<td align="center">${fast.ll}</td>
	<td align="center">${fast.vertical}</td>
