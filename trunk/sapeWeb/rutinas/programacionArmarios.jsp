...
<% java.util.List listaHoraArmario = (java.util.List) request.getAttribute("listaHoraArmario"); %>
<jsp:useBean id="armario" class="java.lang.String" scope="request"/>


<html>
<!-- programacionArmarios.jsp -->
<title>Programacion de Armarios - SAPE</title>
...
<tr>
<td  BGCOLOR="" align=center><font color="WHITE" face="Arial, Helvetica, sans-serif" size="3"><B>Programacion de Armarios</B>
<br> 
Armario: ${armario}
</font>
</td>
...
<jsp2:forEach var="hor" items="${listaHoraArmario}">
