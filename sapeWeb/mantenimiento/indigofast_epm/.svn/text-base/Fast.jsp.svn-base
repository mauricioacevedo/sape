...
<title>Operaciones sobre Fast</title>
</head>
...
function resetFast(){
	...
	if(confirm("Se reseteara el Fast "+nombreFast+"\na traves del indigo "+numeroIndigo+", desea continuar?")){
		var winTransfer=window.open("${pageContext.request.contextPath}/actionSape?accion=mantenimientoIndigoFast&operacion=resetFast&indigo="+indigo+
									"&fast="+fast,'Modificar','scrollbars=yes,resizable=yes,hotkeys=yes,height=420,width=500,left=150,top=100,menubar=no,toolbar=no');
		winTransfer.focus();
	}
...
<div align="center"><a href="${pageContext.request.contextPath}/actionSape?accion=mantenimientoIndigoFast&operacion=cargarArchivoFast">Cargar Archivo Fast</a>
&nbsp;
&nbsp;
<a href="${pageContext.request.contextPath}/actionSape?accion=mantenimientoIndigoFast&operacion=listaFast">Ingresar Fast</a>
&nbsp;
</div>
...
<tr bgcolor="black">
	<td align="center" colspan="2">
		<font color="WHITE" class="mensajeCentral">Operaciones Sobre Fast</font>
...
<tr>
<td align="center" colspan="2">
<input type="button" name="rFast" value="Resetear Fast" onclick="javascript:resetFast();" class="boton">
</td>
</tr>
